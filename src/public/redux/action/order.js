...
export const postOrder = (data) =>{
    ...
    return{
        type:'POST_ORDER',
        payload:Axios.post(api+'order',{id_user: data.id_user, id_destination: data.id_destination, id_transaksi: data.id_transaksi, category: data.category, price_order:data.price, date: data.date})
    }
}
